...
from myAPP.YOLO_V5.utils.general import xyxy2xywh, xywh2xyxy, xywhn2xyxy, xyn2xy, segment2box, segments2boxes, resample_segments, \
    clean_str
from myAPP.YOLO_V5.utils.torch_utils import torch_distributed_zero_first
...
class LoadStreams:  # multiple IP or RTSP cameras
    ...
    def update(self, index, cap):
        ...
        while cap.isOpened():
            ...
            cap.grab()  # The methods/functions grab the next frame from video file or camera and return true (non-zero) in the case of success.
